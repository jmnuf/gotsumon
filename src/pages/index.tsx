...
const Home: NextPage = () => {
	...
	return (
		<>
			...
			<main className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-b from-[#160036] to-[#000228]">
				<div className="container flex flex-col items-center justify-center gap-12 px-4 py-16 ">
					<h1 className="flex flex-col font-extrabold tracking-tight text-white sm:text-[5rem] text-center">
						<span className="md:text-9xl text-7xl underline text-[hsl(280,100%,70%)]">Gotsumon</span>
						<span className="md:text-6xl text-5xl max-w-full">The Activity Logger</span>
					</h1>
